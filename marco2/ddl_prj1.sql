...
CREATE TABLE TB_ATIVIDADE (
    ...
    TP_FORMATO           VARCHAR(20)      DEFAULT 'Presencial',
    QT_VAGAS             INTEGER,
    QT_CARGA_HORARIA     NUMERIC(4,1),
    DS_LOCAL             VARCHAR(100),
    ...
    CONSTRAINT CK_TP_FORMATO CHECK (TP_FORMATO IN ('Presencial', 'Online')),
    CONSTRAINT CK_ATIVIDADE_CARGA_HORARIA CHECK (QT_CARGA_HORARIA >= 0),
